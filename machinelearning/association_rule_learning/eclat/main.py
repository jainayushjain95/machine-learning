...
print('\nStep 3 - Training the Eclat Model on the dataset')
...
print('\nStep 4 - Displaying the first results coming directly from the output of the Eclat function')
results = list(rules)
# print(results)
...
print('\nStep 6 - Displaying the results sorted by descending support')
